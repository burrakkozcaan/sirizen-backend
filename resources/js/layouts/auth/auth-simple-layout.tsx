...
export default function AuthSimpleLayout({
    ...
    return (
        <div className="flex min-h-svh flex-col items-center justify-center gap-6 bg-background p-6 md:p-10 overflow-visible">
                ...
                <div className="flex flex-col gap-8 overflow-visible">
                    <div className="flex flex-col items-center gap-4">
                        ...
                        >
                            ...
                            <span className="text-xl font-bold text-[#F4711A]">Sirizen</span>
                        </Link>
