...
class SocialProofRuleSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ($categoryGroups as $categoryGroup) {
            ...
            SocialProofRule::updateOrCreate(
                ['category_group_id' => $categoryGroup->id, 'type' => 'cart_count'],
                [
            ...
            SocialProofRule::updateOrCreate(
                ['category_group_id' => $categoryGroup->id, 'type' => 'view_count'],
                [
            ...
            SocialProofRule::updateOrCreate(
                ['category_group_id' => $categoryGroup->id, 'type' => 'sold_count'],
                [
            ...
            SocialProofRule::updateOrCreate(
                ['category_group_id' => $categoryGroup->id, 'type' => 'review_count'],
                [
